...
public class BlockBlockBoosterT2 extends BlockHorizontal {
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag)
    {
        ...
        tooltip.add("§b\u00a7o"+I18n.format("booster_t2.descr"));
        tooltip.add("§b\u00a7o"+I18n.format("booster_t2.power", ModConfig.boosterT2Config.rf_per_tick));
        tooltip.add("§b\u00a7o"+I18n.format("booster_t2.rate", ModConfig.boosterT2Config.boost_rate));
    }
